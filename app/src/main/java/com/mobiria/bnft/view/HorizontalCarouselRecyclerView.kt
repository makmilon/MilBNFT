...
class HorizontalCarouselRecyclerView(
    ...
    private val activeColor by lazy { ContextCompat.getColor(context, R.color.app_color) }
    private val inactiveColor by lazy { ContextCompat.getColor(context, R.color.app_color2) }
