...
class DroppedAdapter(viewModels: MutableList<ViewModel>) : DataBindingRecyclerViewAdapter(viewModels) {

    private val mViewModelMap = HashMap<Class<*>, Int>()

    init {
        mViewModelMap[DroppedItemViewModel::class.java] = R.layout.layout_dropped_item
